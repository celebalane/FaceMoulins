	...
	<section class="col-md-12 col-xs-12 col-sm-12" id="don">
		...
		<div class="row">
			...
			<article class="col-md-6">
				<h4>Particulier</h4>
				<div class="col-md-6">
					<p>Vous bénéficiez d’une réduction d’impôt sur le revenu de 66 % dans la limite de 20% de votre revenu imposable (ex : un don de 250 € ne vous coûtera que 100 €). Si le plafond de 20 % des revenus est dépassé, le bénéfice de la réduction peut être reporté sur les 5 années suivantes.
		...
		<div class="row" id="bandeauDon">
			<div class="col-md-12" >
				<a class="btn btn-default col-md-6 col-md-offset-3" href="contact.php" role="button">Faire un don</a>
			</div>
		</div>
	</section>
</div>
