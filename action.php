 	...
 	<div class="row" id="presentation">
	 	<section class="col-md-12 col-xs-12 presentation">
	          ...
	          <article id="Palmares">
	            ...
	            <hr>
	            <div class="text-left">
	            	<video width="520" height="300" controls="controls" src="video/video3.mp4">Cv Vidéo</video>
	            	<video width="520" height="300" controls="controls" src="video/video4.mp4">Cv Vidéo</video>
	            </div>
	            <hr>
