	...
	<h1 class="col-md-12 boxtitle titreSection">Actions</h1>
	 		<section class="col-md-12 col-xs-12" id="presentation">
	          	...
	          	<article id="action" class="row">
	            	<h3 class="text-center"><i class="fa fa-film" aria-hidden="true"></i> CV vidéo</h3>
	            	...
	            	<h3 class="text-center"><i class="fa fa-graduation-cap" aria-hidden="true"></i> Ouverture de la Fabrik du numérique</h3>
	            	...
	            	<h3 class="text-center"><i class="fa fa-lightbulb-o" aria-hidden="true"></i> Création du projet Civigaz</h3>
	            	...
	            	<h3 class="text-center"><i class="fa fa-users" aria-hidden="true"></i> Café d'en Face</h3>
